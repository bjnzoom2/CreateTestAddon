...
public class CTAStress extends ConfigBase {
    ...
    public static <B extends Block, P> NonNullUnaryOperator<BlockBuilder<B, P>> setImpact(double value) {
        return builder -> {
            assertFromCTA(builder);
            ResourceLocation id = CreateTestAddon.asResource(builder.getName());
    ...
    private static void assertFromCTA(BlockBuilder<?, ?> builder) {
        if (!builder.getOwner().getModid().equals(CreateTestAddon.MOD_ID)) {
            throw new IllegalStateException("Unrelated blocks cannot be added to the config of Create: Test Addon.");
        }
    }
