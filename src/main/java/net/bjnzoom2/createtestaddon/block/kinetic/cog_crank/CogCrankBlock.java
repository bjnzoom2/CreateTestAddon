...
import net.bjnzoom2.createtestaddon.config.CreateTestAddonConfigs;
import net.bjnzoom2.createtestaddon.registry.ModBlockEntityTypes;
...
public class CogCrankBlock extends HandCrankBlock implements ICogWheel {
    ...
    public InteractionResult use(BlockState state, Level worldIn, BlockPos pos, Player player, InteractionHand handIn,
        ...
        if (!player.getItemInHand(handIn)
            ...
            player.causeFoodExhaustion(getRotationSpeed() * CreateTestAddonConfigs.server().kinetics.cogCrankHungerMultiplier.getF());
    ...
    public BlockEntityType<? extends CogCrankBlockEntity> getBlockEntityType() {
        return ModBlockEntityTypes.COG_CRANK.get();
    }
