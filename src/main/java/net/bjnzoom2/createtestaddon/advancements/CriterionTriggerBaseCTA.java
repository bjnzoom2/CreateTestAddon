...
public abstract class CriterionTriggerBaseCTA<T extends CriterionTriggerBaseCTA.Instance> implements CriterionTrigger<T> {
    public CriterionTriggerBaseCTA(String id) {
        this.id = CreateTestAddon.asResource(id);
    }
